...
p = Menu.create!(name: "使用者資訊", icon: "user", pos: 0, link: "user")
p.desc = "管理使用者資料"; p.save!; p.move_to_child_of(adm)
p = Menu.create!(name: "題目資訊", icon: "tasks", pos: 1, link: "task")
...
um.move_to_child_of(root)
p = Menu.create!(name: "班級資訊", icon: "group", pos: 0, link: "group")
p.desc = "管理班級資料"; p.save!; p.move_to_child_of(um)
p = Menu.create!(name: "學生資訊", icon: "graduation-cap", pos: 0, link: "student")
...
p = Menu.create!(name: "迷你測驗", icon: "fa-check-square-o", pos: 1, link: "task")
